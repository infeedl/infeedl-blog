...
<p>
<h4 id="infeed:facebooktwitter">Infeed: Facebook, Twitter</h4>

<h4 id="Платныйпоиск:googleyandex">Платный поиск: Google, Yandex</h4>

<h4 id="Виджетырекомендаций:taboolaoutbrain">Виджеты рекомендаций: Taboola, Outbrain</h4>

<h4 id="Промосписки:amazonfoursquare">Промосписки: Amazon, Foursquare</h4>
</p>
